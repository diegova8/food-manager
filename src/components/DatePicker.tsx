          ...
          <div className="p-3">
            <DayPicker
              ...
              classNames={{
                ...
                day_button: 'w-full aspect-square rounded-xl text-sm font-medium transition-all duration-150 hover:bg-teal-50 hover:text-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-1',
