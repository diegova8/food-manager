          ...
          <div className="p-3">
            <DayPicker
              ...
              classNames={{
                ...
                weekday: 'flex-1 text-xs font-semibold text-slate-400 uppercase text-center py-2',
                week: 'w-full flex',
                day: 'flex-1 p-0.5 text-center',
                day_button: 'w-full aspect-square rounded-xl text-sm font-medium transition-all duration-150 hover:bg-orange-50 hover:text-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-1',
