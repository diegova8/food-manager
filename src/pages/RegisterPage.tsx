          ...
          <div className="max-w-md w-full">
            <div className="bg-white rounded-2xl shadow-xl p-10 text-center border border-green-200">
              ...
              <p className="text-slate-700 mb-2 text-lg">
                Bienvenido, <span className="font-semibold text-orange-600">{formData.name}</span>
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
            ...
            <div className="px-8 py-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button
                  type="submit"
                  disabled={loading || !formData.email || !formData.password || !formData.name || !formData.phone || formData.password !== formData.confirmPassword}
